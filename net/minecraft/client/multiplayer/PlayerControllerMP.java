...
public class PlayerControllerMP
{
    ...
    public void onPlayerRightClick(final EntityPlayerSP thePlayer, final WorldClient theWorld, final Container inventoryContainer, final double d, final EnumFacing up, final int i) {
    }
}
