...
public class GuiConnecting extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.networkManager == null) {
            this.drawCenteredString(this.fontRendererObj, I18n.format("connect.connecting", new Object[0]), (float)(this.width / 2), (float)(this.height / 2 - 50), 16777215);
        }
        else {
            this.drawCenteredString(this.fontRendererObj, I18n.format("connect.authorizing", new Object[0]), (float)(this.width / 2), (float)(this.height / 2 - 50), 16777215);
        }
