package wtf.infamous.awt.gui.clickgui;
...
public class Panel
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (Dawn.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New")) {
        ...
        else if (Dawn.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("Dawn")) {
        ...
        if (this.extended && !this.Elements.isEmpty()) {
            ...
            final int epanelcolor = Dawn.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? -14474461 : (Dawn.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("Dawn") ? -1879048192 : 0);
